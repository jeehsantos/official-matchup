...
export function BottomNav() {
  ...
  const navItems = [
    { icon: Calendar, label: t("bottomNav.myGames"), path: "/games" },
    { icon: Map, label: t("bottomNav.explore"), path: "/courts" },
    { icon: Search, label: t("bottomNav.find"), path: "/discover" },
    { icon: Users, label: t("bottomNav.groups"), path: "/groups" },
