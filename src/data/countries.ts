...
export const countries: Country[] = [
  ...
  { code: "CD", name: "Congo (DRC)", flag: getFlagEmoji("CD") },
  ...
  { code: "KP", name: "Korea (North)", flag: getFlagEmoji("KP") },
...
export const getFlagEmojiByCode = (code: string | null | undefined): string => {
  if (!code) return "🌍";
  const codePoints = code
    .toUpperCase()
    .split("")
